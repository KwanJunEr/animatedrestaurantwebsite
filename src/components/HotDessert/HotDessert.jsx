  ...
  return (
    <section>
        <div className="container py-12" >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 sm:grid-cols-2">
                {HotDessertData.map((item)=>{
                    return(
                        ...
                        initial="hidden"
                        whileInView="show"
                        className='group bg-white/50 shadow-md p-3 flex items-center gap-10 '>
                            <img src = {item.img} alt = "" className='w-24 rounded-full h-24 img-shadow group-hover:scale-125 transition-all duration-700 group-hover:rotate-[50deg]'/>
                            <div>
