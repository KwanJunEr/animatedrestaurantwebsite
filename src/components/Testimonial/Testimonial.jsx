      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-14 place-items-center">
        ...
        <div className="space-y-5 lg:max-w-[400px]">
            ...
            className="text-xl font-serif relative z-10">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse officiis odio iure commodi 
                ullam perspiciatis molestias beatae omnis?Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit, quidem.
            </motion.h1>
